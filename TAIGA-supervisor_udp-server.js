...
var clientAddress = "0.0.0.0"; var clientPort = 0;
...
serialTAIGA.open(function (error) {
  if ( error ) {
	...
	stateVector.push(((data.charCodeAt(0)<< 24) | 
((data.charCodeAt(1)&0xFF) << 16) | ((data.charCodeAt(2)&0xFF) << 8) | 
((data.charCodeAt(3)&0xFF)))/10000);
	stateVector.push(((data.charCodeAt(4)<< 24) | 
((data.charCodeAt(5)&0xFF) << 16) | ((data.charCodeAt(6)&0xFF) << 8) | 
((data.charCodeAt(7)&0xFF)))/10000);
	stateVector.push(((data.charCodeAt(8)<< 24) | 
((data.charCodeAt(9)&0xFF) << 16) | ((data.charCodeAt(10)&0xFF) << 8) | 
((data.charCodeAt(11)&0xFF)))/1000);
	stateVector.push(((data.charCodeAt(12)<< 24) | 
((data.charCodeAt(13)&0xFF) << 16) | ((data.charCodeAt(14)&0xFF) << 8) | 
((data.charCodeAt(15)&0xFF)))/1000);
